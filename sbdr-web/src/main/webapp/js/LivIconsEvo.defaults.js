...
function LivIconsEvoDefaults () {
	...
	var default_options = {
		...
		strokeColor: '#fff', //when style opt is 'filled' or 'lines' or ('lines-alt' / 'linesAlt')
		strokeColorAction: '#0a212f', //when 'style' is 'original', 'filled' or 'lines' and 'colorsOnHover' or 'colorsWhenMorph' is 'custom'
		strokeColorAlt: '#0a212f', //when style opt is ('lines-alt' / 'linesAlt')
