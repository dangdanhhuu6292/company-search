    ...
    .directive('ngSparklineSeriesbar', function () {
        ...
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.myPoints = $scope.initPoints || [];
                if ($scope.init == true) {     // init with 0 values
                    for (var i = 0; i < $scope.maxPoints; i++) {
                    	if ($scope.myPoints.length < i)
                ...
                $scope.$watch('initPoints', function (updatedValue, oldValue, $scope) {
                    $scope.myPoints = updatedValue;    
                    $scope.myPoints = $scope.myPoints.filter(function(e) {return e !== undefined})
