...
public class CreateOldNotificationAlertsJob extends QuartzJobBean {
	private static final Logger logger = LoggerFactory.getLogger(CreateOldNotificationAlertsJob.class);
