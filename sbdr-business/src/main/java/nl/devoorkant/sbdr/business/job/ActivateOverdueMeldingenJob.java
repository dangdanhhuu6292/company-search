...
public class ActivateOverdueMeldingenJob extends QuartzJobBean {
	private static final Logger logger = LoggerFactory.getLogger(ActivateOverdueMeldingenJob.class);
	...
	public void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		try {
			bedrijfService.activateOverdueMeldingen();
